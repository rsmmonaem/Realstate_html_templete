                        ...
                        <div class="row justify-content-between">
                                ...
                                <div class="widget footer-widget">
                                    ...
                                    <div class="th-widget-contact">
                                        <div class="info-box_text">
                                            ...
                                            <div class="details">
                                                <p>Doreen Tower,</p>
                                                <p>6 Kamal Ataturk Ave, Dhaka 1213</p>
                                            </div>
                                        </div>
                                        <div class="info-box_text">
                                            <div class="icon">
                                            ...
                                            <div class="details">
                                                <p><a href="tel:+0123456789" class="info-box_link">+8801897623950</a></p>
                                            </div>
                                        </div>
                                        <div class="info-box_text">
                                            <div class="icon">
                                            ...
                                            <div class="details">
                                                <p><a href="mailto:mailinfo00@realar.com" class="info-box_link">info@mermaidgroupbd.com</a></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 col-xl-auto">
                                <div class="widget widget_nav_menu footer-widget">
                                    ...
                                    <div class="menu-all-pages-container">
                                        <ul class="menu">
                                            <li><a href="#l">All Properties</a></li>
                    ...
                    <div class="row gy-2 align-items-center">
                        <div class="col-lg-6">
                            <p class="copyright-text">
                                Copyright <i class="fal fa-copyright"></i> 2024 <a style="font-weight: 600;" href="#">Mermaid Group</a>, All rights reserved.
                            </p>
                        </div>
                        <div class="col-lg-6 text-center text-lg-end">
                            <div class="footer-links">
                                <ul>
                                    ...
                                    <li><a style="font-weight: 600;" target="_blank" href="https://www.nibizsoft.com/">Powered by NIBIZ SOFT</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
